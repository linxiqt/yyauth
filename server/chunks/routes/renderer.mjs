...
import { x as joinRelativeURL, u as useRuntimeConfig, y as getResponseStatusText, z as getResponseStatus, A as defineRenderHandler, f as getQuery, n as createError, B as getRouteRules, b as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"高效的软件授权管理系统，轻松管理您的软件授权"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/logo.svg"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap"}],"style":[],"script":[],"noscript":[],"title":"简授权系统"};
