...
const _changelogId__delete = defineEventHandler(async (event) => {
  try {
    ...
    await db("changelogs").where("id", changelogId).delete();
    return {
      success: true,
      message: "\u66F4\u65B0\u65E5\u5FD7\u5DF2\u6210\u529F\u5220\u9664"
    };
  } catch (error) {
    console.error("\u5220\u9664\u66F4\u65B0\u65E5\u5FD7\u51FA\u9519:", error);
    return {
      success: false,
      message: "\u670D\u52A1\u5668\u9519\u8BEF\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5"
    };
...
export { _changelogId__delete as default };
//# sourceMappingURL=_changelogId_.delete.mjs.map
