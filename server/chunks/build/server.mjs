import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, defineAsyncComponent, defineComponent, computed, unref, h, Suspense, nextTick, mergeProps, provide, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { C as createHooks, D as getContext, n as createError$1, E as toRouteMatcher, F as createRouter, G as defu, H as hasProtocol, I as joinURL, J as withQuery, K as sanitizeStatusCode, L as isScriptProtocol, M as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "buy",
    path: "/buy",
    component: () => import('./buy.vue.mjs')
  },
  {
    name: "code",
    path: "/code",
    component: () => import('./code.vue.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "install",
    path: "/install",
    component: () => import('./install.vue.mjs')
  },
  {
    name: "license",
    path: "/license",
    component: () => import('./license.vue.mjs')
  },
  {
    name: "profile",
    path: "/profile",
  ...
  },
  {
    name: "auth-query",
    path: "/auth/query",
    component: () => import('./query.vue.mjs')
  },
  {
    name: "auth-create",
    path: "/auth/create",
  ...
  },
  {
    name: "auth-reseller",
    path: "/auth/reseller",
    component: () => import('./reseller.vue.mjs')
  },
  {
    name: "auth-edit-id",
    path: "/auth/edit/:id()",
  ...
  },
  {
    ...
    component: () => import('./homepage.vue.mjs')
  }
];
