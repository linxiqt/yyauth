...
fun isNewerVersion(currentVersion: String, latestVersion: String): Boolean {
    ...
    return true
              ...
              </pre></div></div></div></section></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/docs/api.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=api.vue.mjs.map
